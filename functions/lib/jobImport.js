 ...
 */
function validateIndeedUrl(url) {
    try {
        ...
        const isJobPage = parsed.pathname.includes('/viewjob') ||
 ...
 */
async function fetchIndeedPage(url) {
 ...
 */
async function parseWithClaude(content, sourceUrl, apiKey, imageBase64) {
...
// MAIN CLOUD FUNCTION
// ============================================================================
exports.parseIndeedJob = (0, https_1.onCall)({
    ...
    if (!request.auth) {
        throw new https_1.HttpsError('unauthenticated', 'You must be logged in to import jobs');
    }
    ...
    try {
        ...
        if (!apiKey) {
            throw new https_1.HttpsError('failed-precondition', 'AI parsing is not configured');
        }
...
//# sourceMappingURL=jobImport.js.map