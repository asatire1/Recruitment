import{c as h,a as u,d as r,q as f,o as c,b as w,f as d,s as l,e as p,u as b,h as v,j as g}from"./index-NO_tzWV3.js";const T=[["path",{d:"M22 17a2 2 0 0 1-2 2H6.828a2 2 0 0 0-1.414.586l-2.202 2.202A.71.71 0 0 1 2 21.286V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z",key:"18887p"}]],D=h("message-square",T),k=[{value:"initial_contact",label:"Initial Contact"},{value:"follow_up",label:"Follow Up"},{value:"interview_invite",label:"Interview Invitation"},{value:"interview_reminder",label:"Interview Reminder"},{value:"trial_invite",label:"Trial Invitation"},{value:"trial_reminder",label:"Trial Reminder"},{value:"offer",label:"Job Offer"},{value:"rejection",label:"Rejection"},{value:"general",label:"General"}],x=[{key:"firstName",label:"First Name",example:"John"},{key:"lastName",label:"Last Name",example:"Smith"},{key:"fullName",label:"Full Name",example:"John Smith"},{key:"jobTitle",label:"Job Title",example:"Dispenser"},{key:"companyName",label:"Company Name",example:"Allied Pharmacies"},{key:"interviewDate",label:"Interview Date",example:"15th January"},{key:"interviewTime",label:"Interview Time",example:"10:00 AM"},{key:"branchAddress",label:"Branch Address",example:"123 High Street, Manchester"},{key:"contactName",label:"Contact Name",example:"Sarah Johnson"},{key:"contactPhone",label:"Contact Phone",example:"07123 456789"}],A=[{name:"Initial Contact",category:"initial_contact",content:`Hi {{firstName}},
...
Thanks`,isDefault:!0}],s="whatsappTemplates";async function L(e,t){const a=u(r,s),n={name:e.name,category:e.category,content:e.content,placeholders:m(e.content),isDefault:!1,createdBy:t,createdAt:l(),updatedAt:l()};return{id:(await d(a,n)).id,...n}}async function N(){const e=u(r,s),t=f(e,c("category"),c("name"));return(await g(t)).docs.map(n=>({id:n.id,...n.data()}))}function P(e){const t=u(r,s),a=f(t,c("category"),c("name"));return w(a,n=>{const o=n.docs.map(i=>({id:i.id,...i.data()}));e(o)},n=>{console.error("Error subscribing to templates:",n)})}async function R(e,t){const a=p(r,s,e),n={...t,placeholders:m(t.content||""),updatedAt:l()};return await b(a,n),{id:e,...n}}async function _(e){const t=p(r,s,e);await v(t)}async function E(e){const t=await N();if(t.length>0)return t;const a=u(r,s),n=[];for(const o of A){const i={...o,placeholders:m(o.content),createdBy:e,createdAt:l(),updatedAt:l()},y=await d(a,i);n.push({id:y.id,...i})}return n}function m(e){const t=/\{\{(\w+)\}\}/g,a=[];let n;for(;(n=t.exec(e))!==null;)a.includes(n[1])||a.push(n[1]);return a}function C(e,t){let a=e;for(const[n,o]of Object.entries(t)){const i=new RegExp(`\\{\\{${n}\\}\\}`,"g");a=a.replace(i,o||"")}return a}function j(e,t={}){return{firstName:e.firstName||"",lastName:e.lastName||"",fullName:`${e.firstName||""} ${e.lastName||""}`.trim(),jobTitle:e.jobTitle||"",companyName:"Allied Pharmacies",interviewDate:t.interviewDate||"",interviewTime:t.interviewTime||"",branchAddress:t.branchAddress||"",contactName:t.contactName||"",contactPhone:t.contactPhone||"",interviewBookingLink:t.bookingUrl||"[Use Invite to Interview button]",...t}}function S(e,t){let a=e.replace(/\D/g,"");a.startsWith("0")?a="44"+a.substring(1):!a.startsWith("44")&&a.length===10&&(a="44"+a);const n=encodeURIComponent(t);return`https://wa.me/${a}?text=${n}`}function H(e){return k.find(a=>a.value===e)?.label||e}export{x as A,D as M,k as T,S as a,j as b,E as c,L as d,_ as e,C as f,H as g,P as s,R as u};
